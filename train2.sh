...
# python train.py --netG resnet_attn --name ResNet_Attn_0630 --gpu 0 > ./log/ResNet_Attn_0630.log  && \
# python train.py --netG selfattentionresunet --name SARU_v2_0630 --gpu 0 > ./log/SARU_v2_0630.log
